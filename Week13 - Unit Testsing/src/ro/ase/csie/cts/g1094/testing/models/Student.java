...
public class Student {
	...
	public void setAge(int age) throws WorngAgeException {
		if(age < MIN_AGE || age > MAX_AGE) {
			throw new WorngAgeException();
		}
		this.age = age;
	}


	public void setGrades(ArrayList<Integer> grades) throws WorngGradesException {
		this.grades = grades;
	}
